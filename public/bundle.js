...
var updatedRunData = _data2.default.days.map(function (day) {
    var updatedEvents = day.events.map(function (evt) {
        return Object.assign(evt, { id: _uuid2.default.v4(), collapsed: true });
    });
    return Object.assign(day, { events: updatedEvents });
});

(0, _reactDom.render)(_react2.default.createElement(_app2.default, { runData: updatedRunData }), document.getElementById("app"));
...
var _dayblock = __webpack_require__(28);
...
var _mainsplash = __webpack_require__(30);

var _mainsplash2 = _interopRequireDefault(_mainsplash);
...
var App = function (_Component) {
    ...
    function App() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = App.__proto__ || Object.getPrototypeOf(App)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            runEvents: _this.props.runData,
            emailText: "",
            commentTitle: "",
            commentText: "",
            commentFormVisibility: false
        }, _this.handleEmailChange = function (e) {
            var latestEmailValue = e.target.value;
            _this.setState(function (prevState) {
                return _extends({}, prevState, {
                    emailText: latestEmailValue
                });
            });
        }, _this.handleEmailSubmit = function (e) {
            e.preventDefault();
        ...
        }, _this.handleCommentFormVisibility = function (e) {
            e.preventDefault();
        ...
        }, _this.handleCommentTitleChange = function (e) {
            var latestCommentTitle = e.target.value;
            _this.setState(function (prevState) {
                return _extends({}, prevState, {
                    commentTitle: latestCommentTitle
                });
            });
        }, _this.handleCommentTextChange = function (e) {
            var latestCommentText = e.target.value;
            _this.setState(function (prevState) {
                return _extends({}, prevState, {
                    commentText: latestCommentText
                });
            });
        }, _this.handleCommentSubmit = function (e) {
            e.preventDefault();
            _this.setState(function (prevState, props) {
                //DO A POST
                return _extends({}, prevState, {
        ...
        }, _this.handleCommentFormClose = function (e) {
            _this.setState(function (prevState, props) {
                return _extends({}, prevState, {
                    commentFormVisibility: false
                });
            });
        }, _this.handleEventDetailCollapse = function (id, e) {
            var dayIndex = null;
            var eventIndex = null;
            ...
            var theDate = _this.state.runEvents.forEach(function (day, day_index) {
                day.events.forEach(function (evt, evt_index) {
                    if (evt.id === id) {
                        dayIndex = day_index;
            ...
            _this.setState(function (prevState) {
                ...
                var firstPart = prevState.runEvents.slice(0, dayIndex); //Begin WEek
                var lastPart = prevState.runEvents.splice(dayIndex + 1); //End Week

                //The Event Element with the value you're changing.
                var updatedElement = Object.assign({}, prevState.runEvents[dayIndex].events[eventIndex], {
                    collapsed: !prevState.runEvents[dayIndex].events[eventIndex].collapsed
                });
                //Day to Change
                //Old day to merge with the new one.

                var updatedDay = Object.assign({}, {
                    day: prevState.runEvents[dayIndex].day
                }, {
                    events: [].concat(_toConsumableArray(prevState.runEvents[dayIndex].events.slice(0, eventIndex)), [updatedElement], _toConsumableArray(prevState.runEvents[dayIndex].events.splice(eventIndex + 1)))
                });

                var finalUpdatedWeek = firstPart.concat(updatedDay).concat(lastPart);
                return _extends({}, prevState, {
    ...
    _createClass(App, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                "div",
                { className: "root" },
                _react2.default.createElement(_commentform2.default, { commentFormVisibility: this.state.commentFormVisibility,
                ...
                _react2.default.createElement(_nav2.default, { days: this.state.runEvents }),
                _react2.default.createElement(
                    "div",
                    { className: "root__main" },
                    _react2.default.createElement(_mainsplash2.default, { onCommentFormVisibility: this.handleCommentFormVisibility }),
                    this.state.runEvents.map(function (item, index) {
                        return _react2.default.createElement(_dayblock2.default, { key: index,
                            day: item.day,
                            events: item.events,
                            onEventDetailChange: _this2.handleEventDetailCollapse });
                    }),
                    _react2.default.createElement(_footer2.default, { emailValue: this.state.emailText,
...
var DayBlockItem = function DayBlockItem(_ref) {
    var event = _ref.event,
        onEventDetailChange = _ref.onEventDetailChange;

    //Details Visibility Here.
    var details = !event.collapsed ? _react2.default.createElement(DayBlockDetails, {
        description: event.description,
        location: event.location }) : null;
    return _react2.default.createElement(
        "div",
        { className: "root__main__block__item" },
        _react2.default.createElement(
            "div",
            { className: "root__main__block__item__header", onClick: onEventDetailChange.bind(undefined, event.id) },
            _react2.default.createElement(
                "span",
                { className: "root__main__block__item__header__name" },
                _react2.default.createElement(
                    "span",
                    { className: "root__main__block__item__header__text" },
                    event.group
                ),
                _react2.default.createElement(
                    "span",
                    { className: "root__main__block__item__header__name__time" },
                    " ",
                    event.start,
                    " - ",
                    event.end
            ...
            _react2.default.createElement("span", { className: "root__main__block__item__header__dropdown" })
        ),
        details
    );
};

var DayBlockDetails = function DayBlockDetails(_ref2) {
    var description = _ref2.description,
        location = _ref2.location;
    return _react2.default.createElement(
        "div",
        { className: "root__main__block__item__details" },
        description,
        _react2.default.createElement("br", null),
        location,
        _react2.default.createElement("div", { className: "root__main__block__item__details__description" }),
        _react2.default.createElement("div", { className: "root__main__block__item__details__location" }),
        _react2.default.createElement("div", { className: "root__main__block__item__details__map" }),
        _react2.default.createElement("div", { className: "root__main__block__item__details__social" })
    );
};
...
exports.default = function (_ref3) {
    var events = _ref3.events,
        day = _ref3.day,
        onEventDetailChange = _ref3.onEventDetailChange;
    return _react2.default.createElement(
        "div",
        { className: "root__main__block" },
        _react2.default.createElement(
            "div",
            { id: day, className: "root__main__block__title" },
            day
        ),
        events.map(function (evt, index) {
            return _react2.default.createElement(DayBlockItem, { key: index,
                event: evt,
...
exports.default = function (_ref) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement("div", { className: "root__left__logo" }),
        _react2.default.createElement(
            "div",
            { className: "root__left__nav" },
            days.map(function (el, index) {
                var anchor = "#" + el.day;
                return _react2.default.createElement(
                    "div",
                    { key: index, className: "root__left__nav__item" },
                    _react2.default.createElement(
                        "a",
                        { href: anchor },
                        el.day
        ...
        _react2.default.createElement(
            "div",
            { className: "root__left__footer" },
            _react2.default.createElement(
                "div",
                { className: "root__left__footer__title" },
                "Social"
            ),
            _react2.default.createElement(
                "div",
                { className: "root__left__footer__icons" },
                _react2.default.createElement("div", { className: "root__left__footer__icons__item root__left__footer__icons__item--fb" }),
                _react2.default.createElement("div", { className: "root__left__footer__icons__item root__left__footer__icons__item--twit" }),
                _react2.default.createElement("div", { className: "root__left__footer__icons__item root__left__footer__icons__item--insta" })
            )
        )
    );
};
...
exports.default = function (_ref) {
    var onCommentFormVisibility = _ref.onCommentFormVisibility;
    return _react2.default.createElement(
        "div",
        null,
        _react2.default.createElement(
            "div",
            { className: "root__main__title" },
            "YVRUN, Running with Strangers"
        ),
        _react2.default.createElement(
            "div",
            { className: "root__main__content" },
            "Here's a list of days, times and places where strangers run together.  It's all over town.  At all times of day.  Some are even at some ungodly hour of the morning."
        ),
        _react2.default.createElement(
            "div",
            { className: "root__main__content" },
            "Send more groups of strangers ",
            _react2.default.createElement(
                "a",
                { href: "mailto:alloauth@gmail.com", onClick: onCommentFormVisibility },
                "here"
            ),
            "."
        )
...
exports.default = function (_ref) {
    var onEmailFormSubmit = _ref.onEmailFormSubmit,
        emailValue = _ref.emailValue,
        onEmailTextChange = _ref.onEmailTextChange;
    return _react2.default.createElement(
        "footer",
        null,
        _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                "form",
                { onSubmit: onEmailFormSubmit.bind(undefined) },
                _react2.default.createElement("input", { className: "footer__form__text",
                    type: "text",
                    value: emailValue,
                    onChange: onEmailTextChange.bind(undefined),
                    placeholder: "your.address@email.com" }),
                _react2.default.createElement("input", { className: "footer__form__submit",
                    type: "submit",
                    value: "Subscribe" })
            )
        )
...
exports.default = function (_ref) {
    var commentFormVisibility = _ref.commentFormVisibility,
        onCommentFormVisibility = _ref.onCommentFormVisibility,
        onCommentSubmit = _ref.onCommentSubmit,
        commentTitle = _ref.commentTitle,
        commentText = _ref.commentText,
        onCommentTitleChange = _ref.onCommentTitleChange,
        onCommentTextChange = _ref.onCommentTextChange;
    return _react2.default.createElement(
        "div",
        { className: "comment",
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                "div",
                { className: "comment__form__exit" },
                _react2.default.createElement("div", { className: "comment__form__exit__button", onClick: onCommentFormVisibility.bind(undefined) })
            ),
            _react2.default.createElement(
                "form",
                ...
                _react2.default.createElement(
                    "div",
                    { className: "comment__form__field" },
                    _react2.default.createElement("input", { type: "text",
                        className: "comment__form__field__input",
                        placeholder: "About",
                        value: commentTitle,
                        onChange: onCommentTitleChange.bind(undefined) })
                ),
                _react2.default.createElement(
                    "div",
                    { className: "comment__form__field" },
                    _react2.default.createElement("input", { type: "text",
                        ...
                        value: commentText,
                        onChange: onCommentTextChange.bind(undefined) })
                ),
                _react2.default.createElement(
                    "div",
                    { className: "comment__form__field" },
                    _react2.default.createElement("input", { type: "submit", className: "comment__form__field__submit" })
                )
            )
        )
    );
...
module.exports = {"days":[{"day":"Sunday","events":[{"group":"5 km & 10 km","start":"10:00 am","end":"12:00 pm","location":"Burnaby Lake (Sprott Street & Sperling Avenue)","description":"Runnin' on a Sunday with strangers.","links":["https://facebook.com","https://instagram.com","https://strava.com"]}]},{"day":"Monday","events":[{"group":"East Van Run Crew","start":"6:30pm","end":"8:00pm","location":"A Brewery in Vancouver","description":"Running and beer because running and beer.","links":["https://facebook.com","https://instagram.com","https://strava.com"]}]},{"day":"Tuesday","events":[{"group":"Running and Sushi","start":"7:00pm","end":"8:00pm","location":"181 Roundhouse Mews, Vancouver BC","description":"Running for 40 minutes from Yaletown Roundhouse Community Centre.  There is sushi after.","links":["https://facebook.com","https://instagram.com","https://strava.com"]},{"group":"Track and Tub","start":"7:00pm","end":"8:00pm","location":"Eric Hamber Secondary School Track","description":"Running fervently around a high school track.","links":["https://facebook.com","https://instagram.com","https://strava.com"]}]},{"day":"Wednesday","events":[{"group":"Running Room on Cambie","start":"6:00m","end":"8:00pm","location":"2317 Cambie Street","description":"Free running club.  10k distance","links":["https://facebook.com","https://instagram.com","https://strava.com"]},{"group":"Mile2Marathon Striders","start":"6:30pm","end":"8:00pm","location":"Point Grey Track","description":"~5km of intense running around a track.","links":["https://facebook.com","https://instagram.com","https://strava.com"]},{"group":"East Van Intervals Striders","start":"6:00pm","end":"8:00pm","location":"1780 E. Broadway (Safeway on Broadway and Commerical)","description":"More intense runnin' with strangers on a Wednesday.","links":["https://facebook.com","https://instagram.com","https://strava.com"]}]},{"day":"Thursday","events":[{"group":"Burnaby Mountain","start":"5:00pm","end":"7:30pm","location":"6568 Hastings Street (Starbucks)","description":"Runnin' with strangers on a Thursday.","links":["https://facebook.com","https://instagram.com","https://strava.com"]},{"group":"Vancouver Running Co","start":"6:15pm","end":"8:00pm","location":"1886 W. 1st Avenue","description":"5 - 6 km and 9-11 km.  There are pacers and it's FREE.","links":["https://vanrunco.com/pages/flight-crew"]}]},{"day":"Friday","events":[{"group":"Fraser Street Run Club","start":"7:00pm","end":"8:30pm","location":"923 East 10th Avenue","description":"Runnin' with strangers on a Friday.","links":["https://www.facebook.com/groups/380233985492086/","https://instagram.com","https://strava.com"]}]},{"day":"Saturday","events":[{"group":"False Creek Loop (4, 6, 8, 11 km)","start":"9:30am","end":"11:00am","location":"#1 Kingsway","description":"Running from Mount Pleasant Community Centre.","links":["https://facebook.com","https://instagram.com","https://strava.com"]},{"group":"Park Run in Richmond","start":"8:45am","end":"10:00am","location":"7891 Cambie Road, Richmond","description":"A free, weekly timed run in Richmond by the Olympic Oval.","links":["https://facebook.com","https://instagram.com","https://strava.com"]}]}]}
