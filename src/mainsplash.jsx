...
export default ({onCommentFormVisibility}) => (
    <div>
        ...
        <div className = "root__main__content">
            Send more groups of strangers <a href = "mailto:alloauth@gmail.com" onClick = {onCommentFormVisibility}>here</a>.
        </div>                            
    </div>
);